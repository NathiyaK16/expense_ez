...
import Icon from 'react-native-vector-icons/Ionicons';
import CheckBox from '@react-native-community/checkbox';
import { useTheme } from '../../theme/useTheme';  // Make sure the theme context is correctly imported
  ...
  return (
    <View style={[styles.claimItem, { backgroundColor: theme.backgroundColor }]}>
      ...
      <View style={styles.claimContent}>
        ...
        <Text style={[styles.amountText, { color: theme.textColor }]}>INR {amount.toLocaleString()}</Text>
      </View>
    </View>
  );
};
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.backgroundColor }]}>
      <View style={[styles.header, { backgroundColor: theme.headerBg }]}>
        <Text style={[styles.headerTitle, { color: theme.textColor }]}>Claims</Text>
        <TouchableOpacity>
          <Icon name="notifications-outline" size={24} color={theme.textColor} />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.segmentContainer}>
        <TouchableOpacity style={styles.segmentButton}>
          <Text style={[styles.segmentText, { color: theme.textColor }]}>Today</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.segmentButton}>
          <Text style={[styles.segmentText, { color: theme.textColor }]}>Approved</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.segmentButton}>
          <Text style={[styles.segmentText, { color: theme.textColor }]}>Filed</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.segmentButton}>
          <Text style={[styles.segmentText, { color: theme.textColor }]}>Amount</Text>
        </TouchableOpacity>
      </View>
